...
class SimilarPelisSlider extends StatefulWidget {
  
  final List<Movie> movies;
  final String? title;
  final Function onNextPage;

  const SimilarPelisSlider({
    Key? key, 
  ...
  @override
  State<SimilarPelisSlider> createState() => _MovieSliderState();
}

class _MovieSliderState extends State<SimilarPelisSlider> {
