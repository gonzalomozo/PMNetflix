...
class ProximasPelisSlider extends StatefulWidget {
  
  final List<Movie> movies;
  final String? title;
  final Function onNextPage;

  const ProximasPelisSlider({
    Key? key, 
  ...
  @override
  State<ProximasPelisSlider> createState() => _MovieSliderState();
}

class _MovieSliderState extends State<ProximasPelisSlider> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 5),
          Text(
            movie.title,style: TextStyle(color: Colors.white),
            maxLines: 1,
